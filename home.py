...
def home_view(content_frame, clear_frame, user_id, db):
    ...
    acc_button = customtkinter.CTkButton(navigation_frame, corner_radius=0, height=40, border_spacing=10,
                                        ...
                                        hover_color=("gray70", "gray30"),image=acc_image, anchor="w",
                                        command=acc_button_event)
    acc_button.grid(row=2, column=0, sticky="ew")
    
    logout_button = customtkinter.CTkButton(navigation_frame, text="Log out", command= logout)
    ...
    def update_account():
        ...
        if existing_email and new_email != old_email:
            ...
            CTkMessagebox(title="check", message="User successfully updated!", icon="check")
    ...
    def update_pass():
        ...
        CTkMessagebox(title="check", message="Password successfully updated!", icon="check")
    ...
    update_button = customtkinter.CTkButton(acc_frame, text="Update", width=200,height=30,command=update_account)
    ...
    update_pass_button = customtkinter.CTkButton(acc_frame, text="Update", width=200,height=30,command=update_pass)
